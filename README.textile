h1. Embedded Localization <a href="http://travis-ci.org/tilo/embedded_localization"><img src="https://secure.travis-ci.org/tilo/embedded_localization.png?branch=master" alt="Build Status"></a>



Embedded_Localization is a Rails 3 and Rails 4 localization gem, targeted at ActiveRecord 3 and 4. It is compatible with and builds on the new "I18n API in Ruby on Rails":http://guides.rubyonrails.org/i18n.html and adds model translations to ActiveRecord.
...
Tested with Rails 3.2.2 , 3.2.16 , 4.0.2
